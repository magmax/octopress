...
BLOG_AUTHOR = "Miguel Ángel García"  # (translatable)
BLOG_TITLE = "MagMax Blog"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link
SITE_URL = "http://magmax.org/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://magmax.org"
BLOG_EMAIL = ""
BLOG_DESCRIPTION = "Blog con mis experiencias en el mundo técnico"  # (translatable)
BLOG_SUBTITLE = "¡Alerta! ¡Código!"
...
# RSS_LINK = None
RSS_LINK = 'http://feeds.feedburner.com/magmax'
...
TWITTER_CARD = {
    ...
    'card': 'summary',          # Card type, you can also use 'summary_large_image',
    # see https://dev.twitter.com/cards/types
    'site': '@magmax',         # twitter nick for the website
    'creator': '@magmax',     # Username for the content creator / author.
}
